  ...
  return (
    <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-2">
                <button
                  ...
                  onClick={() => isEditing && setFormData((prev) => ({ ...prev, role: "jobSeeker" }))}
                  disabled={!isEditing}
                >
                  Job Seeker
                </button>
                <button
                  ...
                  onClick={() => isEditing && setFormData((prev) => ({ ...prev, role: "recruiter" }))}
                  disabled={!isEditing}
                >
                  Recruiter
                </button>
      ...
      <div className="bg-white rounded-lg shadow-card p-6">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-base font-medium text-secondary-900 mb-2">Change Password</h3>
            <p className="text-secondary-600 text-sm mb-4">Ensure your account is using a secure password</p>
            <button className="btn btn-outline">Update Password</button>
          </div>

          <div className="pt-4 border-t border-secondary-200">
            <h3 className="text-base font-medium text-secondary-900 mb-2">Two-Factor Authentication</h3>
            <p className="text-secondary-600 text-sm mb-4">Add an additional layer of security to your account</p>
