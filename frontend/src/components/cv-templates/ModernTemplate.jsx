...
const ModernTemplate = ({ data }) => {
  ...
  return (
    <div className="bg-white shadow-lg w-full h-full overflow-hidden flex">
      {/* Sidebar */}
      <div className="bg-gray-800 text-white w-1/3 p-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    {skill.proficiency && (
                      <span className="text-xs">
                        ...
                        {skill.proficiency === "advanced" && "Advanced"}
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4">
              {experience.map((exp, index) => (
                <div
                  key={index}
                  className="border-l-2 border-gray-300 pl-4 ml-2 relative"
                >
            ...
            <div className="space-y-4">
              {education.map((edu, index) => (
                ...
                >
                  ...
                  {edu.gpa && (
                    <p className="mt-1 text-gray-600">GPA: {edu.gpa}</p>
                  )}
                  {edu.description && (
